---
layout: default
title: Stručný průvodce světem SWU
permalink: /
---
...
### Carbonite a další změny

Od edice JTL začali vydávat Carbonite balíčky, jež stály pětkrát více než tradiční booster, ale měli větší pravděpodobnost, že se v nich objeví showcase leader (přibližně osmkrát). Počet karet zůstával stejný, akorát leader byl vždy minimálně v HS verzi a balíček obsahoval 7 foil karet, 5 HS karet, 2 HS foil karty a vždy jednu novou **Prestige** kartu některé karty z edice v normální či foil verzi (dříve jen jednotky, nyní i eventy).
...
### Karabast
Pro účely živého hraní slouží stránka [karabast.net](https://karabast.net/), kam je taktéž nutné vložit balík (odkaz na swudb či seznam karet vyexportovaný z swudb či melee) a následně je možné hrát jak privátní, tak náhodná veřejná utkání s živými hráči. Je to skvělý způsob si hru více otestovat. Pokud se zde hráč zaregistruje, pak mezi dvěma registrovanými hráči je možné i komunikovat skrze interní chat.
...
### SWU Competitive Hub
Podobně jako SWUBASE i stránka [SWU Competitive Hub](https://www.swu-competitivehub.com/) prezentuje jinou formou výsledky posledních turnajů, stručné statistiky a i obsahy jednotlivých balíčky hráčů.
